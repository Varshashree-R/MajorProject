...
const RentalPropertyDetail = () => {
  ...
  return (
    ...
    <p>{format(realEstate?.area)} sq. feet</p>
  </div>
  ...
  <div className="flex items-center gap-2">
    <span className="font-semibold">Parking Availability</span>
    <p>{realEstate?.parking_availability ? "Yes" : "No"}</p>
  </div>
